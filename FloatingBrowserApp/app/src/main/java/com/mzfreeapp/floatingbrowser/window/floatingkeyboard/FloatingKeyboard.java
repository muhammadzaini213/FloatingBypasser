...
import static com.mzfreeapp.floatingbrowser.window.floatingwindow.bottomnavbar.BottomNavbarLayer2Item.setKeyboardWindowListener;
...
public class FloatingKeyboard extends Service {
    ...
    public void onCreate() {
        ...
        utils.init(keyboardView, windowManager, metrics, sp);
